"""Feather (Arrow IPC) exporter for NutritionEntry and DailySummary."""
...
def entries_to_feather_bytes(entries: List[NutritionEntry]) -> bytes:
    """Serialize a list of NutritionEntry objects to Feather format bytes."""
...
def summaries_to_feather_bytes(summaries: List[DailySummary]) -> bytes:
    """Serialize a list of DailySummary objects to Feather format bytes."""
